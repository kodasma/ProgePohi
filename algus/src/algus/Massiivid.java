...
public class Massiivid {
    ...
    public static int[] piirid(int[] arvud){
        ...
        vastus[0]=vastus[1]=vastus[0]; //esimese arvu omistab vastuse mõlemale kohale
        for(int arv: arvud){
            if(arv<vastus[0]){
                vastus[0]=arv;
            }
    ...
    public static void main(String[] arg){
        ...
        System.out.println("Pikkuste summa: " + (summa(pikkused)));
        System.out.println("Keskmine pikkus:" + keskmine(pikkused));
